...
export default function CustomerOrderDetailPage() {
  ...
  if (loadError || !order) {
    return (
      <main className="mx-auto flex-1 max-w-2xl px-6 py-16">
        <Link href="/customer/orders" className="text-sm text-primary-text hover:underline">
          ← Back to orders
        </Link>
  ...
  return (
    <main className="mx-auto flex-1 max-w-2xl px-6 py-16">
      ...
      <div className="mt-6 flex items-start justify-between gap-4">
        ...
        <span className="shrink-0 rounded-full bg-lavender-grey-100 px-3 py-1 text-xs font-medium text-lavender-grey-800">
          ...
          <ol className="mt-3 flex flex-col gap-2">
            {order.statusHistory.map((entry, i) => (
              <li key={i} className="flex items-center gap-3 text-sm">
                <span className="h-2 w-2 shrink-0 rounded-full bg-lavender-grey-500" />
