      ...
      <div className="mt-10">
        {isLoading ? (
          ...
          <p className="text-muted">
            No orders yet —{" "}
            <Link href="/listings" className="text-primary-text hover:underline">
              browse the circle
            </Link>{" "}
            ...
            {orders.map((order) => (
              <li key={order.id}>
                ...
                >
                  ...
                  <span className="rounded-full bg-lavender-grey-100 px-2 py-0.5 text-xs font-medium text-lavender-grey-800">
